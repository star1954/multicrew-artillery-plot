...
public class PingDetect {
    ...
    private static LinkedList<LinkedList<Rectangle>> pingList = new LinkedList<LinkedList<Rectangle>>();
    ...
    public static void calcCorrelations(Main.Callback<Double[], ?> callback, Main.Callback<Integer, Double[]> callback2, Rectangle basePing){
